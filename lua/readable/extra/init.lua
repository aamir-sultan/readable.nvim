...
function M.setup()
  ...
  for extra, info in pairs(M.extras) do
    package.loaded["readable.extra." .. extra] = nil
    local plugin = require("readable.extra." .. extra)
    for style, style_name in pairs(styles) do
      readable.setup({ style = style })
      readable.load({ style = style })
      vim.cmd.colorscheme("readable-" .. style)
      local colors = require("readable.colors").setup({ transform = true })
      local fname = extra .. "/readable_" .. style .. "." .. info.ext
      colors["_upstream_url"] = "https://github.com/folke/readable.nvim/raw/main/extras/" .. fname
      colors["_style_name"] = "Tokyo Night" .. style_name
      colors["_name"] = "readable_" .. style
